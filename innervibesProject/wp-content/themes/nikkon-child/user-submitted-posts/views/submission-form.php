	...
	<form id="usp_form" method="post" enctype="multipart/form-data" data-parsley-validate action="">
		...
		<fieldset class="usp-images">
			...
			if ($usp_minImages > 0) : ?>
				...
				<input name="user-submitted-image[]" type="file" multiple accept='image/*' size="25"<?php echo $usp_required; ?> class="usp-input usp-clone<?php echo $usp_files; ?> exclude">
				<?php endfor; ?>
				<?php if ($usp_minImages < $usp_maxImages) : echo $usp_addAnother; endif; ?>
			<?php else : ?>
				
				<input name="user-submitted-image[]" type="file" multiple accept='image/*' size="25" class="usp-input usp-clone exclude">
